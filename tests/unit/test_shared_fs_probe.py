...
# gap documented in STATE.md Deferred Items; matches the proven pattern at
# tests/integration/test_systemname_yaml_end_to_end.py:36-39 + tests/unit/
# test_capacity_gate.py:37-39).
