...
| Area       | Problem                         | Model                | Data Loader | Dataset seed                             | Minimum AU% | Target GiB/s per Process |
|------------|---------------------------------|----------------------|-------------|------------------------------------------|-------------|:------------------------:|
| Vision     | Image segmentation (medical)    | 3D U-Net             | PyTorch     | KiTS 19 (140MB/sample)                   | 90%         |       2.959 GiB/s        |
| Vision     | Image classification            | ResNet-50            | TensorFlow  | ImageNet (150KB/sample)                  | 90%         |       0.191 GiB/s        |
| Scientific | Cosmology                       | parameter prediction | TensorFlow  | CosmoFlow N-body simulation (2MB/sample) | 70%         |       0.753 GiB/s        |
| Vision     | Text to Image                   | Flux                 | Pytorch     | cc12m                                    | 90%         |       0.114 GiB/s        | 
| Vision     | Object Detection (light weight) | RetinaNet            | Pytorch     | Open Images                              | 90%         |                          |
