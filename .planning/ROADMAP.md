...
- [x] 05.2-01-PLAN.md — HANDFILL-01: soft-pair diff pre-pass for hand-filled scalar fingerprint positions; RED-first (test → feat) per `feedback_tdd_red_first_even_for_shipped_fixes`; D-60 reverse-direction INFO log; D-61 strict-signature filter; D-63 ambiguous fallback
...
| 5.2. Diff-Layer Hand-Fill Affordance | 1/1 | Complete   | 2026-06-25 |
